...
export class InitSchema1755714475476 implements MigrationInterface {
    name = 'InitSchema1755714475476'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "profiles" ("created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "id" SERIAL NOT NULL, "first_name" character varying(100) NOT NULL, "last_name" character varying(100) NOT NULL, "role" "public"."profiles_role_enum" NOT NULL, "phone_number" character varying(50) NOT NULL, "street_address1" character varying(255) NOT NULL, "street_address2" character varying(255), "city" character varying(100), "state" character varying(100), "postal_code" character varying(20), "website" character varying(255), "referred_by" character varying(255), "seeking_employment" boolean, "linkedin_profile" character varying(255), "eligibility" "public"."profiles_eligibility_enum", "military_branch_affiliation" "public"."profiles_military_branch_affiliation_enum", "military_ets_date" date, "user_id" integer, CONSTRAINT "REL_9e432b7df0d182f8d292902d1a" UNIQUE ("user_id"), CONSTRAINT "PK_8e520eb4da7dc01d0e190447c8e" PRIMARY KEY ("id"))`);
